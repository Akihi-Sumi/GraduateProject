...
class _$ItemModelImpl extends _ItemModel {
  ...
  @override
  String toString() {
    return 'ItemModel(itemId: $itemId, expirationDate: $expirationDate, name: $name, isChecked: $isChecked, time: $time)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, itemId, expirationDate, name, isChecked, time);
...
abstract class _ItemModel extends ItemModel {
  const factory _ItemModel(
      ...
      final String name,
      final bool isChecked,
      final int time}) = _$ItemModelImpl;
